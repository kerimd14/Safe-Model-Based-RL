...
class PolicyRunner:
    ...
    def __init__(
        ...
        self.flat_input_fn = self.mpc.make_flat_input_fn()       # already fixed in MPC
    ...
    def warmstart_hidden(self, params, warmup_steps: int = 50):
        """
        Equivalent to old RNN_warmstart(), but without rebuilding env/mpc every time.
        """
        self.cache.reset()
